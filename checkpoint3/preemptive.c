...
__data __at (0x25) char thread_bitmap;
__data __at (0x26) char current_thread;
__data __at (0x27) char saved_sp[4];
__data __at (0x2B) char i; // for loop
__data __at (0x2C) char new_thread;
__data __at (0x2D) char sp_temp;
