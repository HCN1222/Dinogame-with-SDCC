...
__data __at (0x28) char thread_bitmap;
__data __at (0x29) char current_thread;
__data __at (0x2A) char saved_sp[4];
__data __at (0x2E) char i; // for loop
__data __at (0x2F) char new_thread;
__data __at (0x30) char sp_temp;
__data __at (0x31) char bitmask[4];
...
void myTimer0Handler(){
    EA = 0;
       ...
       do {
                ...
                if ( thread_bitmap & bitmask[current_thread] ){
                    break;
                }
        } while (1);
        POP_REGS_FROM_STACK;
...
void ThreadExit(void) {
         ...
         */
    EA = 0;
        thread_bitmap &= ~bitmask[current_thread];
        for ( i = 0; i < 4; i++ ){
            if ( thread_bitmap & bitmask[i] ){
                current_thread = i;
                break;
